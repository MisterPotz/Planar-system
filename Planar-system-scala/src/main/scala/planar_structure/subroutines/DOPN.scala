 ...
 */
object DOPN{
  val KHE_GLOBAL = Array(1f, 0.5f,0.25f,0.18f,0.125f, 0.063f)
  val KFE_GLOBAL = Array(Array(1f,1f),
                          Array(0.3f, 0.2f),
    Array(0.14f, 0.1f),
    Array(0.06f,0.04f),
    Array(0.038f, 0.016f),
  ...
  def DOPN(N2 : Float, LH : Float, U : Float, NP : Float, NRR : Int, HRC1: Float, HRC2 : Float, SGT1 : Float,
           SGT2 : Float, SF : Float, NZAC1 : Float, NZAC2 : Float, ZETR : Float, YR : Float, KFC1: Float, KFC2 : Float,
           V : Float, M : Float, KHE : Array[Float] = KHE_GLOBAL, KFE : Array[Array[Float]] = KFE_GLOBAL) :
  ...
  (Float, Float, Float, Float, Float, Float) = {
    ...
    val endNumber = 22
    var NF0 = 4.0e6f
    val N : mutable.ArrayBuffer[Float] = ArrayBuffer(N2, N2*U)
    ...
    while(currentOperationNumber != endNumber){
        currentOperationNumber match {
          ...
          case 7 =>
            ...
            NFE(current_loop_iteration) = 60f*LH *N(current_loop_iteration) * KFE(NRR)(0) * NZAC(current_loop_iteration)
            if (HRC(current_loop_iteration) > 35f)
              NFE(current_loop_iteration) = 60f * LH * N(current_loop_iteration)*KFE(NRR)(1)*NZAC(current_loop_iteration)
          ...
          case 9 =>
            ...
            assignOperationNumber(() => current_loop_iteration - 1, 10,10,11)
          case 10 =>
          ...
          case 11 =>
            ...
            SGFM2D = SFD(current_loop_iteration)
            assignOperationNumberN(12)
          case 12 =>
            current_loop_iteration=current_loop_iteration+1 //lo
