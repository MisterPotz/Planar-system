...
import planar_structure.mechanism.types.{CarrierPosition, Internal1}

class Mechanism2kh_I1(carrierPosition: CarrierPosition) extends Mechanism2KH{
  override val gearStructureCharacteristic = GearStructure2KHCharacteristic(Internal1,carrierPosition)
  override lazy val methods: GeometricMethod = Geometric2KHMethod(this)
  calculator  = null //TODO wheel calculator
}